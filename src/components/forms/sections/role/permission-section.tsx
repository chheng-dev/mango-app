...
export interface PermissionSectionProps {
  ...
  setFormErrors?: React.Dispatch<React.SetStateAction<{ permissions?: string }>>;
...
export function PermissionSection({ permissions, formData, setFormData, formErrors, setFormErrors, expandAllSections, collapseAllSections, toggleSection }: PermissionSectionProps) {
                        ...
                        onCheckedChange={(checked) => {
                          ...
                          setFormData((prev: any) => ({
                            ...
                            permissions: checked
                              ...
                              : prev.permissions.filter((id: any) => !resourcePermissionIds.includes(id))
                          }));
                          if (formErrors.permissions && setFormErrors) {
                            setFormErrors((prev: any) => ({ ...prev, permissions: '' }));
                          }
                              ...
                              onCheckedChange={(checked) => {
                                setFormData((prev: any) => ({
                                  ...
                                  permissions: checked
                                    ...
                                    : prev.permissions.filter((id: any) => id !== permission.id)
                                }));
                                if (formErrors.permissions && setFormErrors) {
                                  setFormErrors((prev: any) => ({ ...prev, permissions: '' }));
                                }
