          ...
          <div className="flex items-center justify-center min-h-[60vh]">
            <div className="text-center space-y-6">
              <div className="relative">
                ...
                <Key className="h-6 w-6 text-primary absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
              </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Card className="border-dashed">
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="text-sm font-medium">Ready to create role?</p>
                    <p className="text-xs text-muted-foreground">
                      Make sure all information is correct before creating the role
                    </p>
                  </div>
                  <div className="flex items-center gap-3">
                    <Button 
