  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setErrors({ email: result.error || 'Failed to create user' });
      }
    } catch (error) {
          ...
          <div className="grid gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Unique identifier for the user (uppercase letters and numbers only)
                    </p>
                  </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Set up the user's login credentials and account access.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Mark user as email verified (can be changed later)
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                    <Switch
